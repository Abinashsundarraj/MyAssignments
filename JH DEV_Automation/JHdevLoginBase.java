...
public class JHdevLoginBase {
		...
		@BeforeMethod
			public  void start() throws InterruptedException, IOException {
				...
				//To launch the URL
				driver.get("https://jh.macriskmanagement.com/?admin=true");
				//To Maximize
	...
	// Set From: header field
		...
		InternetAddress[] toAddresses = { new InternetAddress("asundarraj@maclear-grc.com"),new InternetAddress("rkanna@maclear-grc.com"),
		...
		// Set Subject: header field
		message.setSubject("JH -DEV Automation report");

		// Create the message part
		BodyPart messageBodyPart = new MimeBodyPart();

		// Now set the actual message
		messageBodyPart.setText("This is Automation Report for JH DEV - Major Functionnality.");
		...
		String filename = "C:\\testleaf\\JH DEV_Automation\\test-output\\emailable-report.html";
		// change to the
