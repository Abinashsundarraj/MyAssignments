...
public class MlhBase {
	...
	public void start() throws InterruptedException, IOException {
		...
		// String dPath = "C:\\Users\\abina\\OneDrive\\Pictures\\Screenshots\\maclear
		// screenshot";
...
// Set From: header field
	...
	// Set Subject: header field
	message.setSubject("MLH-DEV Automation Report");

	// Create the message part
	BodyPart messageBodyPart = new MimeBodyPart();

	// Now set the actual message
	messageBodyPart.setText("This is Automation Report for MLH DEV - Major Functionnality");
	...
	String filename = "C:\\testleaf\\MLH DEV_Automation\\test-output\\emailable-report.html";
	// change to the
