...
public class BHEprodLoginBase {
		...
		@BeforeMethod
			public  void start() throws InterruptedException, IOException {
				 ...
				 driver=new ChromeDriver(); 
					...
					//password
					driver.findElement(By.id("Password")).sendKeys("Abinash@123");
					Thread.sleep(3000);
	...
	// Set From: header field
		...
		new InternetAddress("delliot@maclear-grc.com")
		...
		// Set Subject: header field
		message.setSubject("BHE-PROD Automation report");

		// Create the message part
		BodyPart messageBodyPart = new MimeBodyPart();

		// Now set the actual message
		messageBodyPart.setText("This is Automation Report for BHE PROD - Major Functionnality.");
		...
		String filename = "C:\\testleaf\\BHCProd_Automation\\test-output\\emailable-report.html";
		// change to the
